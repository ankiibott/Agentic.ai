...
if analyze_clicked:
    if llm is None:
        st.error("Google API key not found. Set GOOGLE_API_KEY/GEMINI_API_KEY or MY_GEMINI_TOKEN in your .env file and restart the app.")
    elif not blood_report.strip():
        with left_col:
